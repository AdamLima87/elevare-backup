        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Visão geral das inspeções e performance sanitária.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card className="lg:col-span-2 p-6">
              <CardHeader className="px-0 pt-0">
                <CardTitle className="text-base font-semibold">
                  Ranking de Não Conformidades por Seção
                </CardTitle>
              </CardHeader>
                  ...
                  <div key={item.id} className="space-y-1">
                    ...
                    <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(item.count / Math.max(...stats.rankingNonConf.map((r: any) => Math.max(r.count, 1)))) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="p-6">
              <CardHeader className="px-0 pt-0 border-b pb-4 mb-4">
                <CardTitle className="text-base font-semibold">
                  Conformidade Média por Segmento
                </CardTitle>
              </CardHeader>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
